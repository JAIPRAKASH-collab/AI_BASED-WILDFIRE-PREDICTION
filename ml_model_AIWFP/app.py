...
model=pickle.load(open('Firemodel_T.pkl','rb'))
...
def main():
    st.markdown("<h1 style='text-align: center; color: white;'>AI BASED WILDFIRE PREDICTION</h1>", unsafe_allow_html=True)
...
add_bg_from_local('sample5.jpeg')    
